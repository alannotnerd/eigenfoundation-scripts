import { Address, ChainalysisRiskLevel, ScreeningData, EligibilityMerkleData, RiskLevelsMapping, EligibleAddressData } from '../types';
import { StandardMerkleTree } from '@openzeppelin/merkle-tree';

export class ElegibilityMerkleTree {
    ...
    private getRiskLevels(screeningData: ScreeningData): RiskLevelsMapping {
        ...
        let addressRiskLevel: RiskLevelsMapping = {};
    ...
    private computeMerkleData(eligibilityData: EligibleAddressData[], riskLevels: RiskLevelsMapping): EligibilityMerkleData {
        return eligibilityData.reduce((acc, data) => {
